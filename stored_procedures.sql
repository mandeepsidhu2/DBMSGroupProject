...
values ("SSN58534", "Arun", "2323232", "da@j.com", 12);
insert into hotel (name, street, town, state, zip, avgrating, phone, email)
values ("Hotel Plaza", "Symphony Street", "Truro", "MA", "02115", 0, "+1 656-334-6296",
        "plaza@hmz.com");
insert into hotel (name, street, town, state, zip, avgrating, phone, email)
values ("Hotel Banquet", "Harrison Street", "Truro", "MA", "02115", 0, "+1 616-334-6296",
        "banquet@hmz.com");

insert into roomcategory (category, hasFridge, hasBalcony, hasBathtub, description)
values ("Deluxe", true, false, false, "Enjoy Deluxe previlige, clean rooms with built in fridge");
insert into roomcategory (category, hasFridge, hasBalcony, hasBathtub, description)
values ("Ultra", true, true, false,
        "Enjoy Ultra previlige, clean rooms with a balcony and built in fridge!");
insert into roomcategory (category, hasFridge, hasBalcony, hasBathtub, description)
values ("Suite", true, true, true,
        "Enjoy our best Suite previlige, clean rooms with  a balcony, bathtub and built in fridge");

insert into rooms (roomno, hotelid, category, floor, capacity)
values (1, 1, "Deluxe", 1, 3);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (2, 1, "Deluxe", 1, 3);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (3, 1, "Deluxe", 1, 3);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (4, 1, "Deluxe", 1, 3);

insert into rooms (roomno, hotelid, category, floor, capacity)
values (5, 1, "Ultra", 1, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (6, 1, "Ultra", 1, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (7, 1, "Ultra", 1, 4);

insert into rooms (roomno, hotelid, category, floor, capacity)
values (8, 2, "Ultra", 1, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (9, 2, "Ultra", 1, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (10, 2, "Ultra", 1, 4);

insert into rooms (roomno, hotelid, category, floor, capacity)
values (11, 2, "Suite", 2, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (12, 2, "Suite", 2, 4);
insert into rooms (roomno, hotelid, category, floor, capacity)
values (13, 2, "Suite", 2, 4);

insert into amenities (name, description)
values ("Swimming pool", "Exquisite swimming pool");
insert into amenities (name, description)
values ("Heating", "Heating available 24*7");
insert into amenities (name, description)
values ("Bar", "In house bar!");
insert into amenities (name, description)
values ("Dining", "Best room service!");
-- set foreign_key_checks=0;


insert into amenitiesathotel (hotelid, amenityId)
values (1, 1);
insert into amenitiesathotel (hotelid, amenityId)
values (1, 2);
insert into amenitiesathotel (hotelid, amenityId)
...
delimiter
//
create procedure getHotelCategoryWiseAvailability(in hotelIdInput int)
begin
select hotel.id,
...
select getTotalRoomsAvailableForHotel(1);
